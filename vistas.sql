...
SELECT e.FECHA AS FECHA_COMPRA, e.TOTAL AS TOTAL_COMPRA, r.CORREO AS CORREO_USUARIO, t.CLAVE AS CLAVE_PRODUCTO
FROM COMPRAS e
INNER JOIN USUARIOS r
ON e.ID_USUARIOS = r.ID_USUARIOS
INNER JOIN PRODUCTOS t
ON e.ID_PRODUCTOS = t.ID_PRODUCTOS;
